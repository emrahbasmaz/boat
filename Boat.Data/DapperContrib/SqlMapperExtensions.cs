...
namespace Dapper.Contrib.Extensions
{
    ...
    public static class SqlMapperExtensions
    {
        ...
        public static int findUpperLetter(string str)
        {
            for (int ctr = 1; ctr < str.Length; ctr++)
            {
                if (Char.IsUpper(str[ctr]))
                {
                    return ctr;
                }
            }
        ...
        public static bool Update<T>(this IDbConnection connection, T entityToUpdate, IDbTransaction transaction = null, int? commandTimeout = null) where T : class
        {
            ...
            sb.AppendFormat("update {0} set ", name.ToUpper(new CultureInfo("en-US", false)));
        ...
        public static bool Delete<T>(this IDbConnection connection, T entityToDelete, IDbTransaction transaction = null, int? commandTimeout = null) where T : class
        {
            ...
            var sb = new StringBuilder();
            sb.AppendFormat("delete from {0} where ", name.ToUpper(new CultureInfo("en-US", false)));
        ...
        class ProxyGenerator
        {
            ...
            private static AssemblyBuilder GetAsmBuilder(string name)
            {
                ...
                //Thread.GetDomain().DefineDynamicAssembly(new AssemblyName { Name = name },AssemblyBuilderAccess.Run);   
